"""Wrapper for the application of the transfer coefficient to primary production. Use xarray.map_block."""
...
def apply_food_efficiency_to_primary_production(state: SeapopymState) -> xr.Dataset:
    ...
    ----------
    state : SeapopymState
        The model state containing primary production by functional group and food efficiency.

    Returns
    -------
    xr.Dataset
        A dataset containing the updated primary production by functional group.
...
"""Kernel to apply food efficiency to primary production."""
